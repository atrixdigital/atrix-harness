---
name: testing-policy
description: What makes a green test suite meaningful — testing the shipped artefact, verifying the world rather than the self-report, and proving a guard actually guards.
source: incident-0004
applies: [**]
---
